...
%---------------------------------------------------------
  \cventry
    ...
    {Aug. 2021-Present} % Date(s)
    {
      ...
      \item{Summer 2023 project}
      \begin{itemize}[label= - ]
                \item Visual Based Navigation with UAV captured aerial imagery Using Deep Learning.
        \end{itemize}   
      \item{Computational Imaging Research Lab. (CIRL)}
      \begin{itemize}[label= - ]
                \item{Working on the development of \textit{physics-guided image restoration} methods using \textit{Deep Learning} approaches in 3D microscopy. Implemented physics-guided method using various methods including UPIGAN (Unrolled Physics-Informed Generative Adversarial Network) in collaboration with Dr. C. Van [3].}
              \item{Simulation of the Optical Transfer function (OTF) for WF, Tunable SIM, and 3Wave SIM Microscopes in collaboration with the University of Valencia to publish new enhancements regarding the Tunable SIM design.}
        \end{itemize}    
        \item{Virtually Integrated Program (VIP)}
        \begin{itemize}
